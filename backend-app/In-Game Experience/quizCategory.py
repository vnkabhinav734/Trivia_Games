...
def lambda_handler(event, context):
    try:
        ...
        # Construct the API URL based on the event's 'category' parameter
        api_url = f'https://us-central1-tagging-392002.cloudfunctions.net/getQuestionsByCategory?category={event["category"]}'
